 ...
 *	Int1Darray
 *
 *	Routine to allocate memory for an 1D array of ints
 *	All array indices are assumed to start with zero.
 *
 *	Arguments:	int number of elements in each dimension
 *	Returns:	Pointer to memory location of first element
 ...
 *
 ***/
int Int1darray(Int1d *thing, size_t xsize) {
  thing->xsize = xsize;
  thing->val = NULL;
  thing->val = malloc(thing->xsize * sizeof(*thing->val));
  if (thing->val == NULL) {
    return (1);
  }
  return (0);
 ...
 *	getInt1Dindex
 *
 *	Routine to return index of a 1D array of ints
 *	All array indices are assumed to start with zero.
 *
 *	Arguments:	int number of elements in each dimension
 ...
 *
 ***/
size_t getInt1dindex(Int1d thing, size_t x) {
  /* Assumes C-ordering */
 ...
 *	free_Int1Darray
 *
 *	Routine to deallocate memory for an 1D array of ints
 *	All array indices are assumed to start with zero.
 *
 *	Arguments:	int number of elements in each dimension
 *	Returns:	Pointer to memory location of first element
 ...
 *
 ***/
void free_Int1darray(Int1d *thing) {
  free(thing->val);
  return;
}
 ...
 *	Int2Darray
 *
 *	Routine to allocate memory for an 2D array of ints
 *	All array indices are assumed to start with zero.
 *
 *	Arguments:	int number of elements in each dimension
 *	Returns:	Pointer to memory location of first element
 ...
 *
 ***/
int Int2darray(Int2d *thing, size_t xsize, size_t ysize) {
  thing->xsize = xsize;
  thing->ysize = ysize;
  thing->val = NULL;
  thing->val = malloc(thing->xsize * thing->ysize * sizeof(*thing->val));
  if (thing->val == NULL) {
    return (1);
  }
  return (0);
 ...
 *	getInt2Dindex
 *
 *	Routine to return index of a 2D array of ints
 *	All array indices are assumed to start with zero.
 *
 *	Arguments:	int number of elements in each dimension
 *	Returns:	Pointer to memory location of first zlement
 ...
 *
 ***/
size_t getInt2dindex(Int2d thing, size_t x, size_t y) {
  /* Assumes C-ordering */
  return ((x * thing.ysize) + y);
  /* Assumes A-ordering */
  /* return ((y * thing.xsize) + x); */
}

/***
 *	free_Int2Darray
 *
 *	Routine to deallocate memory for an 2D array of ints
 *	All array indices are assumed to start with zero.
 *
 *	Arguments:	int number of elements in each dimension
 *	Returns:	Pointer to memory location of first element
 ...
 *
 ***/
void free_Int2darray(Int2d *thing) {
  free(thing->val);
  return;
}
...
int Int3darray(Int3d *thing, size_t xsize, size_t ysize, size_t zsize) {
  ...
  thing->val = NULL;
  thing->val =
      malloc(thing->xsize * thing->ysize * thing->zsize * sizeof(*thing->val));
  if (thing->val == NULL) {
    return (1);
  }
  return (0);
