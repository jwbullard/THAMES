 ...
 ******************************************************/
const std::string THAMES_Version_string = "#THAMES:Version:";
const std::string THAMES_Xsize_string = "#THAMES:X_Size:";
const std::string THAMES_Ysize_string = "#THAMES:Y_Size:";
const std::string THAMES_Zsize_string = "#THAMES:Z_Size:";
const std::string THAMES_ImgRes_string = "#THAMES:Image_Resolution:";
const std::string THAMES_Version = "5.0";
