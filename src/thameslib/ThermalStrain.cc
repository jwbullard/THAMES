...
void ThermalStrain::relax(int kmax) {
  ...
  */
  ...
  cout << endl << "       relax_ 0 kmax = " << kmax << endl;
  for (int kkk = 0; kkk < kmax; kkk++) {
    ...
    cout << endl << "          relax_ 01 kkk = " << kkk << endl;
    ...
    cout << endl << "          relax_ 02 kkk = " << kkk << endl;

    // utot = energy(nx_, ny_, nz_, ns_);
    utot = energy();

    cout << endl << "          relax_ 03 kkk = " << kkk << endl;
    ...
    if (gg_ >= gtest_) {
      ...
      cout << endl << "       relax_ 1 kmax = " << kmax << endl;
      // stress(nx_, ny_, nz_, ns_);
      stress();
      cout << endl << "       relax_ 2 kmax = " << kmax << endl;
  ...
  cout << endl << "       relax_ 3 kmax = " << kmax << endl;
  // stress(nx_, ny_, nz_, ns_);
  stress();
  cout << endl << "       relax_ 4 kmax = " << kmax << endl;
  ...
  for (k = 0; k < nz_; k++) {
    ...
    for (j = 0; j < ny_; j++) {
      ...
      for (i = 0; i < nx_; i++) {
        ...
        cout << endl << "           stress_ 1-0 m = " << m << endl;
        ...
        cout << endl << "             stress_ 1-1 m = " << m << endl;
        for (int n = 0; n < 6; n++) {
        ...
        elestrain_[m][4] = s23;
        elestrain_[m][5] = s12;
        cout << endl << "             stress_ 1-2 m = " << m << endl;
        ...
        ///
        cout << endl << "             stress_ 1-3 m = " << m << endl;
        getAvgStrainengy();
        cout << endl << "             stress_ 1-4 m = " << m << endl;
...
void ThermalStrain::Calc(double time, vector<int> *p_vectPhId,
  ...
  cout << endl << "   ThermalStrain::Calc_ 0" << endl;

  // ppixel(fileName);
  ppixel(p_vectPhId);

  cout << endl << "   ThermalStrain::Calc_ 1" << endl;
  ///
  /// Count and output the volume fractions of the different phases.
  ///

  assig();
  cout << endl << "   ThermalStrain::Calc_ 2" << endl;
  ...
  */
  ...
  cout << endl << "   ThermalStrain::Calc_ 3" << endl;
  ...
  cout << endl << "   ThermalStrain::Calc_ 4" << endl;
  ///
  ...
  cout << endl << "   ThermalStrain::Calc_ 5" << endl;
  relax(kmax);

  cout << endl << "   ThermalStrain::Calc_ 6" << endl;
